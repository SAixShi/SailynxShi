...
-- FunciÃƒÂ³n para crear switches de auto-equip
...
-- Ã¢Å¡Â¡ BotÃƒÂ³n que ejecuta todos los scripts remotos
...
Credits:AddLabel("ðŸ”¥H3LL_KYYðŸ”¥")
...
Credits:AddLabel("TANG INA NYO MGA BASURANG BINGOT 300â‚± LANG TONG SCRIPT")
